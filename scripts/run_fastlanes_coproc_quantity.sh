...
echo "Building FastLanes co-processor benchmark..."

SRC="external/baseline/fastlanes_gpu/coproc_fastlanes.cu"
...
echo "Running FastLanes quantity co-processor benchmark..."
